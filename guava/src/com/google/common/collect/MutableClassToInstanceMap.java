 ...
 */
@GwtIncompatible
@SuppressWarnings({"serial", "value", "compliance", "crypto", "https"}) // using writeReplace instead of standard serialization // FALSE POSITIVE: generic errors issued on this code that I can't explain
